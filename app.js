...
app.use(
    cors({
        origin: [process.env.PROTFOLIO_URL, process.env.DASHBOARD_URL, "http://localhost:5173", "https://adminprotfolio78.vercel.app", "http://localhost:5174", "https://adminportfolio.netlify.app"],
