...
const { addNewProject, updateProject, getAllProject, getSingleProject, deleteProject, getOneProject } = require("../controller/projectController.js");
...
router.get("/project", getOneProject);
